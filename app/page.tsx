...
const AnimatedStopwatch: React.FC = () => {
  ...
  const [dotPosition, setDotPosition] = useState<number>(89);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
      <div className="flex flex-col sm:flex-row w-full max-w-3xl justify-between px-6 gap-y-6">
        ...
        <div className="w-64 max-h-96 overflow-y-auto hover:bg-gray-800/80 bg-gray-800 p-4 rounded mx-auto items-center">
          {laps.length === 0 ? (
            <div className="text-center py-8 items-center h-full flex flex-col">
